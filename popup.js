...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Enable the button after a certain number of seconds (e.g., 5 seconds)
    setTimeout(function () {
            ...
            chrome.tabs.query(
                ...
                function (tabs) {
                    if (tabs[0]) {
                        ...
                        // Send a message to the content script to trigger the quickExport function
                        chrome.scripting.executeScript({
                            target: { tabId: tabId },
                            function: () => {
                                // This code will run in the content script context
                                WAXP = (function () {
                                    MutationObserver =
                                    ...
                                    console.log(
                                        "%c WhatsApp Group Contacts Exporter ",
                                        "font-size:24px;font-weight:bold;color:white;background:green;"
                                    );
                                    ...
                                    var start = function () {
                                        ...
                                        TOTAL_MEMBERS =
                                            membersList.parentElement.parentElement
                                                .querySelector("span")
                                                .innerText.match(/\d+/)[0] * 1;
                                    ...
                                    var autoScroll = function () {
                                        if (
                                            !utils.scrollEndReached(
                                                header.nextSibling
                                            )
                                        )
                                            header.nextSibling.scrollTop +=
                                                SCROLL_INCREMENT;
                                        else stop();
                                    };
                                    ...
                                    var stop = function () {
                                        ...
                                        observer.disconnect();
                                        console.log(
                                            `%c Extracted [${utils.queueLength()} / ${TOTAL_MEMBERS}] Members. Starting Download..`,
                                            `font-size:13px;color:white;background:green;border-radius:10px;`
                                        );
                                        downloadAsCSV([
                                            "Name",
                                            "Phone",
                                    ...
                                    var scrapeData = function () {
                                        ...
                                        for (
                                            ...
                                            console.log(
                                                `%c Extracted [${utils.queueLength()} / ${TOTAL_MEMBERS}] Members `,
                                                `font-size:13px;color:white;background:green;border-radius:10px;`
                                            );
                                        }
                                    };
                                    ...
                                    var scrapeName = function (el) {
                                        var expectedName;
                                        expectedName =
                                            el.firstChild.firstChild.childNodes[1].childNodes[1].childNodes[1].querySelector(
                                                "span"
                                            ).innerText;
                                        if (expectedName == "") {
                                            return el
                                                .querySelector("span[title]")
                                                .getAttribute("title"); //phone number
                                        }
                                        return expectedName;
                                    };
                                    ...
                                    var downloadAsCSV = function (header) {
                                        ...
                                        var fileName = groupName.replace(
                                            /[^\d\w\s]/g,
                                            ""
                                        )
                                            ? "Contacts"
                                    ...
                                    var quickExport = function () {
                                        ...
                                        fileNameArr.pop(); //removing 'YOU' from array
                                        // convert groupNames to array
                                        var groupArray = groupName.split(", ");
                                        groupArray.pop(); //removing 'YOU' from array
                                        ...
                                        } else if (fileNameArr.length != 0) {
                                            for (
                                                i = 0;
                                                i < fileNameArr.length;
                                                ++i
                                            ) {
                                                if (
                                                    fileNameArr[i].match(
                ...
                function: () => {
                    ...
                    WAXP = (function () {
                        ...
                        var start = function () {
                            ...
                            // click the `n more` button to show all members
                            document
                                .querySelector("span[data-icon=down]")
                                ?.click();
                        ...
                        var scrapeData = function () {
                            var contact, status, name;
                            var memberCard =
                                membersList.querySelectorAll(":scope > div");
                            console.log(memberCard);
                            for (let i = 0; i < memberCard.length; i++) {
                                status = memberCard[i].querySelectorAll(
                                    "span[title]"
                                )[1]
                                    ? memberCard[i].querySelectorAll(
                                        "span[title]"
                                    )[1].title
                                    : "";
                                ...
                                if (
                                    ...
                                    MEMBERS_QUEUE[contact.phone].Status =
                                        status;
                                }
                        ...
                        var scrapePhoneNum = function (el) {
                            ...
                            if (
                                el.querySelector("img") &&
                                el.querySelector("img").src.match(/u=[0-9]*/)
                            ) {
                                phone = el
                                    .querySelector("img")
                                    .src.match(/u=[0-9]*/)[0]
                         ...
                         */
                        var downloadAsCSV = function (header) {
                            var groupName = document.querySelectorAll(
                                "#main > header span"
                            )[1].title;
                            var fileName = groupName.replace(/[^\d\w\s]/g, "")
                                ? "Contacts"
                                : "WAXP-group-members";
                                ...
                                if (utils.queueLength() > 0) {
                                    for (key in MEMBERS_QUEUE) {
                                        ...
                                        if (header.includes("Status"))
                                            data += `"${MEMBERS_QUEUE[key]["Name"]
                                                }","${key}","${MEMBERS_QUEUE[key][
                                                    "Status"
                                                ].replace(/\"/g, "'")}"\n`;
                                        else
                                            data += `"${MEMBERS_QUEUE[key]["Name"]}","${key}"\n`;
                        ...
                        var quickExport = function () {
                            var members = document
                                .querySelectorAll("#main > header span")[2]
                                .title.replace(/ /g, "")
                                .split(",");
                            var groupName = document.querySelectorAll(
                                "#main > header span"
                            ...
                            if (members.length != 0) {
                                ...
                                for (i = 0; i < groupArray.length; ++i) {
                                    if (
                                        ...
                                        MEMBERS_QUEUE[groupArray[i]] = {
                                            Name: NAME_PREFIX + groupArray[i],
                                        };
                                        continue;
                                    } else if (!UNKNOWN_CONTACTS_ONLY) {
                                        MEMBERS_QUEUE[groupArray[i]] = {
                                ...
                                for (i = 0; i < fileNameArr.length; ++i) {
                                    if (
                                        ...
                                        MEMBERS_QUEUE[fileNameArr[i]] = {
                                            Name: NAME_PREFIX + fileNameArr[i],
                                        };
                                        continue;
                                    } else if (!UNKNOWN_CONTACTS_ONLY) {
                                        MEMBERS_QUEUE[fileNameArr[i]] = {
                            ...
                            return {
                                ...
                                queueLength: function () {
                                    var size = 0,
                                        key;
                                    for (key in MEMBERS_QUEUE) {
                                        if (MEMBERS_QUEUE.hasOwnProperty(key))
                                            size++;
                                    }
                                    return size;
                                },
