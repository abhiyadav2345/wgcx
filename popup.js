document.addEventListener("DOMContentLoaded", function () {
    function isWhatsAppURL(url) {
        // Add your logic to check if the URL matches WhatsApp Web's URL pattern
        // For example, you can check if it contains "web.whatsapp.com"
    ...
    chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
        ...
        var isWhatsAppUrl = isWhatsAppURL(currentUrl);
        ...
        if (!isWhatsAppUrl) {
            ...
            document.getElementById("message").textContent =
                "Please open a WhatsApp tab.";
        } else {
            // Enable the button if it's a WhatsApp URL
                            ...
                            WAXP = (function () {
                                ...
                                var scrapeData = function () {
                                    ...
                                    for (
                                        ...
                                        if (
                                            utils.queueLength() >= TOTAL_MEMBERS
                                        ) {
                                            stop();
                                            break;
                                        }
